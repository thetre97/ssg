...
const serverConfig: ServerConfig = {
  data: async ({ store }) => {
    ...
    const authorsCollection = store.createCollection('Author', { primaryKey: 'id', uniqueKeys: ['id'] })
    ...
    const collection = store.createCollection('post', { primaryKey: 'id', uniqueKeys: ['id', 'slug'] })
